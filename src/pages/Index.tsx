...
import { Globe, Layers, Zap, Code, Shield, BookOpen, Package, Database, Server, Shuffle, Play } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 mb-8 border border-white/20 shadow-lg">
          <div className="text-center mb-6">
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Сгенерировать рандомное интервью</h2>
            <p className="text-sm text-gray-600">Выберите технологии и получите список случайных вопросов из каждой темы для подготовки к собеседованию</p>
          </div>
