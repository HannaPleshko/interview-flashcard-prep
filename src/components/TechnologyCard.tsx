      ...
      >
        ...
        <div className="hidden md:block">
          ...
          <CardContent className="text-center relative z-10 pb-8">
            <p className="text-gray-600 mb-6 text-sm leading-relaxed h-12">{tech.description}</p>
        ...
        <div className="md:hidden">
          <div className="p-4">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-3">{tech.description}</p>
