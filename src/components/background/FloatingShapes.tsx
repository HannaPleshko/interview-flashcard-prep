      ...
      {[...Array(15)].map((_, index) => (
        ...
        >
          <div 
            ...
            style={{
              borderBottomColor: index % 3 === 0 ? 'rgba(139, 92, 246, 0.4)' :
                                index % 3 === 1 ? 'rgba(59, 130, 246, 0.4)' :
                                'rgba(147, 51, 234, 0.4)',
          ...
          <div 
            ...
            style={{
              background: `linear-gradient(45deg, ${
                index % 4 === 0 ? 'rgba(139, 92, 246, 0.3), rgba(59, 130, 246, 0.3)' :
                index % 4 === 1 ? 'rgba(59, 130, 246, 0.3), rgba(6, 182, 212, 0.3)' :
                index % 4 === 2 ? 'rgba(147, 51, 234, 0.3), rgba(139, 92, 246, 0.3)' :
